...
This assignment is an evaluation of \citet{TANG2018129}, an observational study whose objective was to ``explore the risk factors that were associated with central lymph node metastases (CLNM) in papillary thyroid carcinoma (PTC) patients".

\section{Data Collection}
The study was done on 202 retrospectively selected patients who had undergone thyroid surgery at the authors' hospital, of which only 180 were considered in the final analysis.
