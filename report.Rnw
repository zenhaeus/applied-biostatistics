...
The combined boxplot of the data suggests that there is a difference of the weight between the two treatments. However it is not possible to determine whether either or even both treatments are significantly different to the control group.\\
