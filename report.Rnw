...
print(
      xtable(tidy(plant.mean), caption = "Mean by group", label = "tab:means"),
      table.placement = "H"
)
print(
      xtable(tidy(plant.var), caption = "Variance by group", label = "tab:variances"),
      table.placement = "H"
)
@
...
print(xtable(anova(plant.mod1), caption = "Results of ANOVA", label = "tab:anova"))

print(xtable(confint(plant.mod1), caption = "Confidence intervals", label = "tab:confint"))
